...
public class Enemy_Shoot_4 : MonoBehaviour {
    ...
    void Awake()
    {
        ...
        Enemy = GameObject.FindGameObjectWithTag("Enemigo 9");
    ...
    {
        if (col.gameObject.tag == "Player" || col.gameObject.tag == "Enemigo 8" || col.gameObject.tag == "Enemigo 10")
        {
            Destroy(gameObject);
        }
    }
