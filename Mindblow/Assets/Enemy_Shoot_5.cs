...
public class Enemy_Shoot_5 : MonoBehaviour {
    ...
    void Awake()
    {
        ...
        Enemy = GameObject.FindGameObjectWithTag("Enemigo 15");
    ...
    {
        if (col.gameObject.tag == "Player" || col.gameObject.tag == "Enemigo 12" || col.gameObject.tag == "Enemigo 13" || col.gameObject.tag == "Enemigo 14")
        {
            Destroy(gameObject);
        }
    }
