...
public class Enemy_Shoot_10 : MonoBehaviour {
    ...
    void Awake()
    {
        ...
        Enemy = GameObject.FindGameObjectWithTag("Laser Pistol 2");
    ...
    {
        if (col.gameObject.tag == "Player" || col.gameObject.tag == "Player_Bullet" || col.gameObject.tag == "Player_Sword" || col.gameObject.tag == "SUELO")
        {
